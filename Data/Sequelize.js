...
models.Document.hasMany(models.RearrangedContent, { foreignkey: 'RearrangedContentId' });
models.RearrangedContent.belongsTo(models.Document, { foreignkey: 'DocumentId'});

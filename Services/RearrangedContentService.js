...
const CreateAsync = errorHandler(async function RearrangedContentService_CreateAsync(authorization, data) {
...
const GetAllAsync = errorHandler(async function RearrangedContentService_GetAllAsync(authorization, id) {
...
const GetByIdAsync = errorHandler(async function RearrangedContentService_GetByIdAsync(authorization, id) {
    const rearrangedContent = await models.RearrangedContent.findByPk(id);

    const document = await documentService.GetByIdAsync(rearrangedContent.DocumentId, authorization);
